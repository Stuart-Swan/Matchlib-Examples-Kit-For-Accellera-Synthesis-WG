...
public:
  ...
  sc_out<sc_lv<type_info_r_master0_ar_dat::width>> CCS_INIT_S1(r_master0_ar_dat);
  sc_out<bool> CCS_INIT_S1(r_master0_r_rdy);
  sc_in<bool> CCS_INIT_S1(r_master0_r_vld);
  sc_in<sc_lv<type_info_r_master0_r_dat::width>> CCS_INIT_S1(r_master0_r_dat);
  sc_in<bool> CCS_INIT_S1(w_master0_aw_rdy);
  sc_out<bool> CCS_INIT_S1(w_master0_aw_vld);
  sc_out<sc_lv<type_info_w_master0_aw_dat::width>> CCS_INIT_S1(w_master0_aw_dat);
  sc_in<bool> CCS_INIT_S1(w_master0_w_rdy);
  sc_out<bool> CCS_INIT_S1(w_master0_w_vld);
  sc_out<sc_lv<type_info_w_master0_w_dat::width>> CCS_INIT_S1(w_master0_w_dat);
  sc_out<bool> CCS_INIT_S1(w_master0_b_rdy);
  sc_in<bool> CCS_INIT_S1(w_master0_b_vld);
  sc_in<sc_lv<type_info_w_master0_b_dat::width>> CCS_INIT_S1(w_master0_b_dat);
  ...
  sc_out<sc_lv<type_info_dma_done_dat::width>> CCS_INIT_S1(dma_done_dat);
  sc_in<bool> CCS_INIT_S1(dma_dbg_rdy);
  sc_out<bool> CCS_INIT_S1(dma_dbg_vld);
  sc_out<sc_lv<type_info_dma_dbg_dat::width>> CCS_INIT_S1(dma_dbg_dat);

  sc_signal<type_info_r_master0_ar_dat::data_type> CCS_INIT_S1(sig_r_master0_ar_dat);
  sc_signal<type_info_r_master0_r_dat::data_type> CCS_INIT_S1(sig_r_master0_r_dat);
  sc_signal<type_info_w_master0_aw_dat::data_type> CCS_INIT_S1(sig_w_master0_aw_dat);
  sc_signal<type_info_w_master0_w_dat::data_type> CCS_INIT_S1(sig_w_master0_w_dat);
  sc_signal<type_info_w_master0_b_dat::data_type> CCS_INIT_S1(sig_w_master0_b_dat);
  ...
  sc_signal<type_info_dma_done_dat::data_type> CCS_INIT_S1(sig_dma_done_dat);
  sc_signal<type_info_dma_dbg_dat::data_type> CCS_INIT_S1(sig_dma_dbg_dat);
